...
class KirchhoffMigration:
    ...
    def __init__(
        ...
        from .migration.kirchhoff import KirchhoffMigration as CoreKirchhoffMigration
        self._delegate = CoreKirchhoffMigration(
            vp=vp,
            sources=sources,
            receivers=receivers,
            shots=shots,
    ...
    def run(self, n_jobs: int = None, show_progress: bool = True):
        return self._delegate.run(n_jobs=n_jobs, show_progress=show_progress)
