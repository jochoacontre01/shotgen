...
def run_gpu_simulation(config_file: str, cli: bool = False, verbose: bool = False) -> None:
...
def run_gpu_simulation_dict(cfg: dict, cli: bool = False, verbose: bool = False) -> dict:
